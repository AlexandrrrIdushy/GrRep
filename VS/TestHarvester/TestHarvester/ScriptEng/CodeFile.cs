	...
	public class CodeFile
	{
												...
												out List<String> pProperties)
		{
			...
			try
			{
				...
				foreach (String CodeLine in CodeLines)
				{
					...
					if (CodeLine.StartsWith("using ", StringComparison.CurrentCultureIgnoreCase))
					{
                        ...
                        //мы тут вытаскиваем строки сборок и исключаем из компиляции. "using" не для компилятора а для IDE
						OK2UseLine = false;
                    ...
                    // здесь мы получаем имя первого класаа для использования как основного. это можно улучшить в дальнейшем чтобы пользователь
                    // сам мог выбирать главного если их много
                    ...
                    //если строка может быть скомпилирована, она добавляется в список
					if (OK2UseLine)
					{
                ...
                //Создание объекта для обработки компилируемого кода.
                ...
                // компиляция кода и создание отчета по результатам
                //DOMRetVal это список сообщения почему был или не был скомпилирован
                ...
                //если нет какой нибудь сборки - не хорошо
				...
				else
				{
                    ...
                    // сообшаем какие сборки были найдены
			...
			catch (Exception exUnhandled)
			{
                ...
                //сюда можно вставить свое расширение обработчика кода. это временно
